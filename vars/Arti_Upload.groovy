        ...
        stage('Artifactory Upload') {
            steps {
                script {
                    ...
                    bat """
                    curl.exe -u admin:password -T "${params.Source_File_Path}\\${params.File_Name}" "http://localhost:8082/artifactory/${params.Artifactory_Target_Folder}/${BUILD_NUMBER}/${params.File_Name}"
